...
//! @details Usa exclusivamente caracteres ASCII para garantizar
//!          compatibilidad con PowerShell y cmd.exe en Windows.
static void imprimirMenu(void) {
    printf("\n");
    printf("\033[1;36m  +---------------------------------+\033[0m\n");
    printf("\033[1;36m  |   \033[1;37mSISTEMA DE ARCHIVOS  v1.0\033[0m\033[1;36m   |\033[0m\n");
    printf("\033[1;36m  +---------------------------------+\033[0m\n");
    printf("\033[1;36m  |\033[0m  \033[1;32m[1]\033[0m  Iniciar sesion           \033[1;36m|\033[0m\n");
    printf("\033[1;36m  |\033[0m  \033[1;32m[2]\033[0m  Crear cuenta             \033[1;36m|\033[0m\n");
    printf("\033[1;36m  |\033[0m  \033[1;31m[3]\033[0m  Salir                    \033[1;36m|\033[0m\n");
    printf("\033[1;36m  +---------------------------------+\033[0m\n");
    printf("\n");
}
...
static void bucleFS(Usuario *usuario, Nodo *root, Nodo *userDir,
    ...
    printf("\n");
    printf("\033[1;36m  >> Bienvenido, \033[1;37m%s\033[0m \033[1;36m[%s]\033[0m\n",
           usuario->usuario,
           usuario->rol == ROL_ADMIN ? "\033[1;31madmin\033[1;36m" : "\033[1;32mcomun\033[1;36m");
    printf("\033[2m     Escribe 'help' para ver los comandos disponibles.\033[0m\n");
    printf("\n");
    ...
    while (1) {
        ...
        if (strcmp(cmd, "exit") == 0 || strcmp(cmd, "logout") == 0) {
            ...
            printf("\n\033[1;32m  [OK] Sesion cerrada. Hasta luego, %s.\033[0m\n\n",
                   usuario->usuario);
            break;
        ...
        //! @brief Comando: help - Muestra la ayuda de comandos
            ...
            printf("\n\033[1;36m  +------------------------------------------+\033[0m\n");
            printf("\033[1;36m  |           COMANDOS DISPONIBLES           |\033[0m\n");
            printf("\033[1;36m  +------------------------------------------+\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mls\033[0m     [ruta]           listar contenido  \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mcd\033[0m     <ruta>           cambiar directorio\033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mmkdir\033[0m  <nombre>         crear directorio  \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mtouch\033[0m  <nombre>         crear archivo     \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mwrite\033[0m  <arch> \"texto\"   escribir archivo  \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mcat\033[0m    <archivo>        leer archivo      \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mrm\033[0m     <ruta>           eliminar          \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mpwd\033[0m                     ruta actual       \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mwhoami\033[0m                  info del usuario  \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;32mclear\033[0m                   limpiar pantalla  \033[1;36m|\033[0m\n");
            printf("\033[1;36m  |\033[0m  \033[1;31mlogout\033[0m  /  \033[1;31mexit\033[0m         cerrar sesion     \033[1;36m|\033[0m\n");
            printf("\033[1;36m  +------------------------------------------+\033[0m\n\n");
...
int main(void) {
    ...
    if (!root) {
        ...
        printf("\033[2m  Sistema iniciado por primera vez. Arbol creado.\033[0m\n");
    } else {
        printf("\033[2m  Datos cargados correctamente.\033[0m\n");
    }
    ...
    while (1) {
        ...
        if (strcmp(opcion, "1") == 0) {
            ...
            if (loginUsuario(&lista, nombre, password, &u)) {
                ...
                printf("\n\033[1;31m  Error: usuario o password incorrectos.\033[0m\n");
            }
            ...
            if (ok) {
                ...
                guardarTodo(&lista, root);
                printf("\033[1;32m  [OK] Cuenta guardada correctamente.\033[0m\n");
            }

        } else if (strcmp(opcion, "3") == 0) {
            guardarTodo(&lista, root);
            printf("\n\033[1;32m  [OK] Datos guardados.\033[0m\033[1;33m Hasta luego!\033[0m\n\n");
            break;

        } else {
            printf("\n\033[1;31m  Opcion invalida. Intenta de nuevo.\033[0m\n");
        }
    }
