//! @file auth.c
//! @brief Implementación de funciones de autenticación y registro
...
//!
//! @details Solicita al usuario:
//!          - ID (4 dígitos, debe existir en credenciales.txt)
//!          - Nombre de usuario (mínimo 3 caracteres, único)
//!          - Password (mínimo 4 caracteres, debe coincidir)
//!          - Key de acceso (determina rol: admin o común)
